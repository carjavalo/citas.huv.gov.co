    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-full mx-auto px-6 py-4">
            <nav class="flex items-center gap-2 text-sm text-gray-600">
                <a class="hover:text-[#2e3a75]" href="<?php echo e(route('dashboard')); ?>">Inicio</a>
                ...
                <div class="ml-auto flex items-center gap-2">
                    <div class="px-3 py-1.5 rounded-lg flex items-center gap-2" style="background-color: rgba(46, 58, 117, 0.1); border: 1px solid rgba(46, 58, 117, 0.3);">
                        <div class="flex flex-col">
                            ...
                            <span class="text-lg font-bold leading-tight" style="color: #2e3a75;"><?php echo e(number_format($totalRegistros)); ?></span>
                        </div>
                    </div>
                    <div class="bg-green-50 px-3 py-1.5 rounded-lg border border-green-200 flex items-center gap-2">
                        <div class="flex flex-col">
                            ...
                            <span class="text-green-700 text-lg font-bold leading-tight"><?php echo e(number_format($ingresos)); ?></span>
                        </div>
                    </div>
                    <div class="bg-red-50 px-3 py-1.5 rounded-lg border border-red-200 flex items-center gap-2">
                        <div class="flex flex-col">
                            ...
                            <span class="text-red-700 text-lg font-bold leading-tight"><?php echo e(number_format($salidas)); ?></span>
                        </div>
                    </div>
                    <div class="bg-blue-50 px-3 py-1.5 rounded-lg border border-blue-200 flex items-center gap-2">
                        <div class="flex flex-col">
                            ...
                            <span class="text-blue-700 text-lg font-bold leading-tight"><?php echo e(number_format($nuevosUsuarios)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-4 py-3 text-xs font-mono font-medium" style="color: #2e3a75;">
                                <?php echo e($actividad->user ? $actividad->user->ndocumento : '-'); ?>

                            </td>
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <div class="size-7 rounded-full flex items-center justify-center text-white font-bold text-[10px]" style="background-color: #<?php echo e(substr(md5($actividad->user_id), 0, 6)); ?>;">
                                        <?php echo e($actividad->user ? strtoupper(substr($actividad->user->name, 0, 2)) : 'NA'); ?>

                                    </div>
                                    <span class="text-sm font-bold text-gray-900">
                                        <?php echo e($actividad->user ? $actividad->user->name . ' ' . $actividad->user->apellido1 : 'Usuario Eliminado'); ?>

                                    </span>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-xs">
                                <?php echo e(\Carbon\Carbon::parse($actividad->created_at)->format('d/m/Y')); ?>

                            </td>
                            <td class="px-4 py-3 text-xs font-medium">
                                <?php echo e(\Carbon\Carbon::parse($actividad->created_at)->format('H:i')); ?>

                            </td>
                            <td class="px-4 py-3">
                                <?php if($actividad->tipo_actividad === 'login'): ?>
                                ...
                                <?php elseif($actividad->tipo_actividad === 'logout'): ?>
                                ...
                                <?php elseif($actividad->tipo_actividad === 'registro'): ?>
                                ...
                                <?php elseif($actividad->tipo_actividad === 'cita'): ?>
                            ...
                            <td class="px-4 py-3">
                                <span class="text-xs text-gray-700"><?php echo e($actividad->descripcion); ?></span>
                            </td>
                            <td class="px-4 py-3">
                                <span class="text-xs font-medium text-gray-600 capitalize"><?php echo e($actividad->modulo ?? '-'); ?></span>
                            </td>
                            <td class="px-4 py-3 text-center">
                                <span class="text-xs font-mono text-gray-500"><?php echo e($actividad->ip_address ?? '-'); ?></span>
                            </td>
                        </tr>
...
<?php /**PATH C:\xampp\htdocs\citas\resources\views/livewire/reporte/ingresos.blade.php ENDPATH**/ ?>