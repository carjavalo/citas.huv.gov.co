<nav x-data="{ open: false }" class="border-b border-gray-100" style="background-color: #2c4370;">
...
<?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('citas.consulta.solicitudes')): ?>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('cita.consultas')).'','active' => request()->routeIs('cita.consultas')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('cita.consultas')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('cita.consultas'))]); ?>
                        <?php echo e(__('Consultar solicitudes')); ?>
...
<?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.usuarios.consult')): ?>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('usuarios.consulta')).'','active' => request()->routeIs('usuarios.consulta')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('usuarios.consulta')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('usuarios.consulta'))]); ?>
                        <?php echo e(__('Consultar usuarios')); ?>
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.eps.consultar')): ?>
                <?php if(! \Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Coordinador')): ?>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('configuracion.eps.consulta')).'','active' => request()->routeIs('configuracion.eps.consulta')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('configuracion.eps.consulta')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('configuracion.eps.consulta'))]); ?>
                        <?php echo e(__('Configuración eps')); ?>
...
<?php endif; ?>
                ...
                <?php endif; ?>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.servicios.consultar')): ?>
...
<?php $component->withAttributes(['align' => 'left','width' => '48']); ?>
                             <?php $__env->slot('trigger', null, []); ?> 
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-transparent hover:text-gray-200 focus:outline-none transition">
                                        <?php echo e(__('Configuración servicios')); ?>
                             ...
                             <?php $__env->slot('content', null, []); ?> 
                                <a href="<?php echo e(route('configuracion.servicios')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                                    <?php echo e(__('Activar servicios')); ?>

                                </a>
                                <?php if(! \Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Coordinador')): ?>
                                <a href="<?php echo e(route('configuracion.sedes')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                                    <?php echo e(__('Sede')); ?>

                                </a>
                                <a href="<?php echo e(route('configuracion.pservicios')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                                    <?php echo e(__('Servicios')); ?>

                                </a>
                                <a href="<?php echo e(route('configuracion.especialidades')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                                    <?php echo e(__('Especialidades')); ?>

                                </a>
                                <?php endif; ?>
                                <?php if(! \Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Coordinador')): ?>
                                <a href="<?php echo e(route('configuracion.campanas')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                                    <?php echo e(__('Campañas')); ?>

                                </a>
                                <?php endif; ?>
                                <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Super Admin')): ?>
                                <div class="border-t border-gray-200 my-1"></div>
                                <a href="<?php echo e(route('configuracion.roles')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                                    <?php echo e(__('Roles')); ?>
...
<?php endif; ?>
             ...
             <!--   <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.reporte.agentes')): ?>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('reporte.solicitudes.procesado')).'','active' => request()->routeIs('reporte.solicitudes.procesado')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('reporte.solicitudes.procesado')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('reporte.solicitudes.procesado'))]); ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         ...
                         <?php $__env->slot('content', null, []); ?> 
                            ...
                            <div class="block px-4 py-2 text-xs text-gray-400">
                                <?php echo e(__('Verificscion de Datos')); ?>

                            </div>-->

                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.reporte.agentes')): ?>
                                   <a href="<?php echo e(route('reporte.solicitudes.procesado')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                            ...
                            <form method="POST" action="<?php echo e(route('logout')); ?>">
                                ...
                                <a href="<?php echo e(route('reporte.solicitudes.reportecitas')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                                   <?php echo e(__('Citas')); ?>

                                </a>

                                <a href="<?php echo e(route('reporte.especialidades')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
                                   <?php echo e(__('Especialidades')); ?>

                                </a>

                                <a href="<?php echo e(route('reporte.ingresos')); ?>" class="block px-4 py-2 text-sm hover:bg-gray-100" style="color: #2c4370;">
...
<!--   --------------------------------------------------------------   ---------->
              ...
              <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Super Admin')): ?>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex text-center">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('obstetricia')).'','active' => request()->routeIs('obstetricia')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('obstetricia')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('obstetricia'))]); ?>
                        <?php echo e(__('Atención Telesalud')); ?>
...
<?php endif; ?>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex text-center">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.nav-link','data' => ['href' => ''.e(route('menuagenda')).'','active' => request()->routeIs('menuagenda')]]); ?>
<?php $component->withName('jet-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('menuagenda')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('menuagenda'))]); ?>
                        <?php echo e(__('Atención Usuarios')); ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                         <?php $__env->slot('trigger', null, []); ?> 
                            ...
                            <?php else: ?>
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-transparent hover:text-gray-200 focus:outline-none transition">
                                        <?php echo e(Auth::user()->name); ?> <?php echo e(Auth::user()->apellido1); ?>
                         ...
                         <?php $__env->slot('content', null, []); ?> 
                            <!-- Account Management -->
                            <div class="block px-4 py-2 text-xs text-gray-400">
                                   <?php echo e(__('Gestionar mi cuenta')); ?>
                            ...
                            <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'Super Admin')): ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.dropdown-link','data' => ['href' => ''.e(route('list_servicios')).'']]); ?>
<?php $component->withName('jet-dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('list_servicios')).'']); ?>
                                    <?php echo e(__('Gestionar Servicios')); ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.dropdown-link','data' => ['href' => ''.e(route('menuagenda')).'']]); ?>
<?php $component->withName('jet-dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('menuagenda')).'']); ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.dropdown-link','data' => ['href' => ''.e(route('operando.sql')).'']]); ?>
<?php $component->withName('jet-dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['href' => ''.e(route('operando.sql')).'']); ?>
                                    <?php echo e(__('Operando')); ?>
...
<?php /**PATH C:\xampp\htdocs\citas\resources\views/navigation-menu.blade.php ENDPATH**/ ?>