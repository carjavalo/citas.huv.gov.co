...
} elseif ($_instance->childHasBeenRendered('8wVbona')) {
    $componentId = $_instance->getRenderedChildComponentId('8wVbona');
    $componentTag = $_instance->getRenderedChildComponentTagName('8wVbona');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8wVbona');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('8wVbona', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
