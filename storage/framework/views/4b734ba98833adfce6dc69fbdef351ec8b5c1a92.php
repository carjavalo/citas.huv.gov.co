    ...
    <div style="background-image: url('<?php echo e(asset('img/huv_fondo_2.jpg')); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; min-height: 100vh;" class="flex items-center justify-center">
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <div class="mb-4 text-sm text-gray-600">
                <?php echo e(__('¿Olvidó su contraseña? Digite su dirección de correo electrónico y le enviaremos un enlace para asignar una nueva contraseña.')); ?>
...
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
                        <?php echo e(__('Restablecer mi contraseña')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\citas\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>