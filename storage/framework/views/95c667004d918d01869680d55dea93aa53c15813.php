                                    ...
                                    <div  class="px-4 py-5 bg-white sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                ...
                                                <input wire:model="nombres" type="text" name="nombres" id="nombres" autocomplete="given-name" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(Auth::user()->name); ?>" disabled>
                                            </div>
                                            <input wire:model="pacid" type="hidden" id="pacid" name="pacid" value="<?php echo e(Auth::user()->id); ?>">
                                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                <label for="apellido1" class="block text-sm font-semibold">Primer apellido</label>
                                                <input wire:model="apellido1" type="text" name="apellido1" id="apellido1" autocomplete="family-name" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(Auth::user()->apellido1); ?>" disabled>
                                            </div>

                                            <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                                                <label for="apellido2" class="block text-sm font-semibold">Segundo apellido</label>
                                                <input wire:model="apellido2" type="text" name="apellido2" id="apellido2" autocomplete="family-name" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(Auth::user()->apellido2); ?>" disabled>
                                            </div>

                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="correo" class="block text-sm font-semibold">Correo electrónico</label>
                                                <input wire:model="correo" type="text" name="correo" id="correo" autocomplete="email" class="mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="<?php echo e(Auth::user()->email); ?>" disabled>
                                            </div>
                                            ...
                                            <div class="col-span-6 sm:col-span-3">        
                                                <?php if($selectpespec && !is_null($servicios) && count($servicios) > 0): ?>  
                                                    ...
                                                    <select wire:model="espec" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none sm:text-sm">
                                                        ...
                                                        <option value="<?php echo e($servicio->servcod); ?>"><?php echo e($servicio->servnomb); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                <?php endif; ?>       
                                                <?php $__errorArgs = ['espec'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="px-2 inline-flex text-ms leading-5 font-semibold rounded-full bg-red-500 text-white"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                                                    </div>
                                                ...
                                                <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <?php $__errorArgs = ['codigo_autorizacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-500 text-white"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <?php if($espec == 1 || $espec == 491 || $espec == 4): ?>
                                                <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                                                    <div class="mb-3 w-96">
                                                    ...
                                                    hover:file:bg-blue-100" id="soporte">
                                                        <?php $__errorArgs = ['soporte_patologia'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-500 text-white"><?php echo e($message); ?></span> <?php unset($message);
    ...
    <script>
        document.addEventListener('livewire:load', function() {
            ...
            $('#select2').on('change', function() {
                window.livewire.find('<?php echo e($_instance->id); ?>').set('espec', this.value);
            });
        });
    </script>
</div>
<?php /**PATH C:\xampp\htdocs\citas\resources\views/livewire/citas/solicitar.blade.php ENDPATH**/ ?>