<div class="font-body bg-gray-100 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 bg-gradient-to-r <?php echo e($seccionHabilitada ? 'from-green-50 to-emerald-50 border-green-200' : 'from-red-50 to-orange-50 border-red-200'); ?> border rounded-xl p-4 shadow-sm">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex items-center">
                    <div class="p-3 rounded-full <?php echo e($seccionHabilitada ? 'bg-green-100' : 'bg-red-100'); ?> mr-4">
                        <span class="material-icons text-2xl <?php echo e($seccionHabilitada ? 'text-green-600' : 'text-red-600'); ?>">
                            <?php echo e($seccionHabilitada ? 'visibility' : 'visibility_off'); ?>

                        </span>
                    </div>
                    <div>
                        <h3 class="font-semibold text-gray-800">Sección "Novedades y Campañas" en Vista Principal</h3>
                        <p class="text-sm <?php echo e($seccionHabilitada ? 'text-green-600' : 'text-red-600'); ?>">
                            <?php echo e($seccionHabilitada ? 'La sección está HABILITADA y visible para los usuarios' : 'La sección está DESHABILITADA y oculta para los usuarios'); ?>

                        </p>
                    </div>
                </div>
                <div class="flex items-center">
                    <span class="mr-3 text-sm font-medium <?php echo e($seccionHabilitada ? 'text-green-700' : 'text-red-700'); ?>">
                        <?php echo e($seccionHabilitada ? 'Habilitada' : 'Deshabilitada'); ?>

                    </span>
                    <button wire:click="toggleSeccionNovedades" 
                            class="relative inline-flex h-8 w-14 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 <?php echo e($seccionHabilitada ? 'bg-green-500 focus:ring-green-500' : 'bg-red-400 focus:ring-red-400'); ?>">
                        <span class="inline-block h-6 w-6 transform rounded-full bg-white shadow-lg transition-transform <?php echo e($seccionHabilitada ? 'translate-x-7' : 'translate-x-1'); ?>"></span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6 bg-gradient-to-r <?php echo e($carruselAutomatico ? 'from-blue-50 to-indigo-50 border-blue-200' : 'from-gray-50 to-slate-50 border-gray-200'); ?> border rounded-xl p-4 shadow-sm">
            <div class="flex flex-col gap-4">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center">
                        <div class="p-3 rounded-full <?php echo e($carruselAutomatico ? 'bg-blue-100' : 'bg-gray-100'); ?> mr-4">
                            <span class="material-icons text-2xl <?php echo e($carruselAutomatico ? 'text-blue-600' : 'text-gray-600'); ?>">
                                <?php echo e($carruselAutomatico ? 'play_circle' : 'pause_circle'); ?>

                            </span>
                        </div>
                        <div>
                            <h3 class="font-semibold text-gray-800">Carrusel Automático de Campañas</h3>
                            <p class="text-sm <?php echo e($carruselAutomatico ? 'text-blue-600' : 'text-gray-600'); ?>">
                                <?php echo e($carruselAutomatico ? 'Las campañas se desplazan automáticamente cada ' . $intervaloCarrusel . ' segundos' : 'El carrusel está en modo manual'); ?>

                            </p>
                        </div>
                    </div>
                    <div class="flex items-center">
                        <span class="mr-3 text-sm font-medium <?php echo e($carruselAutomatico ? 'text-blue-700' : 'text-gray-700'); ?>">
                            <?php echo e($carruselAutomatico ? 'Automático' : 'Manual'); ?>

                        </span>
                        <button wire:click="toggleCarruselAutomatico" 
                                class="relative inline-flex h-8 w-14 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 <?php echo e($carruselAutomatico ? 'bg-blue-500 focus:ring-blue-500' : 'bg-gray-400 focus:ring-gray-400'); ?>">
                            <span class="inline-block h-6 w-6 transform rounded-full bg-white shadow-lg transition-transform <?php echo e($carruselAutomatico ? 'translate-x-7' : 'translate-x-1'); ?>"></span>
                        </button>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 border-t border-gray-200 pt-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm font-bold text-blue-600 bg-blue-50 px-3 py-1 rounded-full min-w-[60px] text-center">
                            <?php echo e($intervaloCarrusel); ?>s
                        </span>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div class="lg:col-span-8 space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-600"><?php echo e($totalActivos); ?></p>
                        </div>
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-blue-600"><?php echo e($totalProgramados); ?></p>
                        </div>
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-slate-600"><?php echo e($totalCampanas); ?></p>
                        </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $campanas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campana): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="campana-card bg-white rounded-xl p-4 shadow-sm border border-gray-200 flex flex-col sm:flex-row gap-4 group hover:border-blue-400 transition-colors <?php echo e($campana->estado !== 'publicado' ? 'opacity-75' : ''); ?>" data-campana-id="<?php echo e($campana->id); ?>">
                    <div class="relative w-full sm:w-48 h-32 flex-shrink-0 rounded-lg overflow-hidden bg-gray-100">
                        <?php if($campana->imagen): ?>
                            <img alt="<?php echo e($campana->titulo); ?>" class="w-full h-full object-cover <?php echo e($campana->estado !== 'publicado' ? 'filter grayscale' : ''); ?>" 
                                 src="<?php echo e(asset('storage/' . $campana->imagen)); ?>"/>
                        <?php else: ?>
                        ...
                        <div class="absolute top-2 left-2 
                            <?php if($campana->estado === 'publicado'): ?> bg-green-500 
                            <?php elseif($campana->estado === 'programado'): ?> bg-blue-500 
                            <?php else: ?> bg-gray-500 <?php endif; ?> 
                            text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">
                            <?php echo e(ucfirst($campana->estado)); ?>
                    ...
                    <div class="flex-1 flex flex-col justify-between">
                        <div>
                            <div class="flex justify-between items-start">
                                <h3 class="font-bold text-lg text-slate-800" style="color: <?php echo e($campana->color_texto); ?>; font-family: <?php echo e($campana->fuente_texto); ?>; font-size: <?php echo e($campana->tamano_texto); ?>;">
                                    <?php echo e($campana->titulo); ?>

                                </h3>
                                <div class="flex items-center space-x-1">
                                    <button wire:click="abrirModalEditar(<?php echo e($campana->id); ?>)" class="p-1.5 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors" title="Editar">
                                        <span class="material-icons text-lg">edit</span>
                                    </button>
                                    <button wire:click="confirmarEliminar(<?php echo e($campana->id); ?>)" class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded transition-colors" title="Eliminar">
                                        <span class="material-icons text-lg">delete</span>
                                    </button>
                                </div>
                            </div>
                            <p class="text-sm text-slate-500 mt-1 line-clamp-2"><?php echo e($campana->descripcion); ?></p>
                        </div>
                        <div class="flex items-center justify-between mt-3 text-xs text-slate-500 border-t border-gray-100 pt-3">
                            <div class="flex items-center space-x-4">
                                <span class="flex items-center">
                                    ...
                                    <?php echo e($campana->fecha_inicio ? $campana->fecha_inicio->format('d M') : 'Sin fecha'); ?> - <?php echo e($campana->fecha_fin ? $campana->fecha_fin->format('d M') : 'Sin fecha'); ?>

                                </span>
                                <span class="flex items-center px-2 py-0.5 rounded
                                    <?php if($campana->categoria === 'urgente'): ?> text-red-600 bg-red-50
                                    <?php elseif($campana->categoria === 'noticia'): ?> text-purple-600 bg-purple-50
                                    <?php elseif($campana->categoria === 'servicio'): ?> text-green-600 bg-green-50
                                    <?php else: ?> text-blue-600 bg-blue-50 <?php endif; ?>">
                                    <?php echo e(ucfirst($campana->categoria)); ?>

                                </span>
                                <?php if($campana->archivo_pdf): ?>
                                    <a href="<?php echo e(asset('storage/' . $campana->archivo_pdf)); ?>" target="_blank" class="flex items-center text-red-500 hover:text-red-700">
                            ...
                            <label class="flex items-center cursor-pointer">
                                ...
                                <div class="relative">
                                    <input type="checkbox" wire:click="toggleVisible(<?php echo e($campana->id); ?>)" <?php echo e($campana->visible ? 'checked' : ''); ?> class="sr-only"/>
                                    <div class="block <?php echo e($campana->visible ? 'bg-green-500' : 'bg-gray-300'); ?> w-10 h-6 rounded-full"></div>
                                    <div class="dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition <?php echo e($campana->visible ? 'transform translate-x-4' : ''); ?>"></div>
                                </div>
                            </label>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition-colors cursor-pointer">
                                ...
                                <label for="imagen-input" class="cursor-pointer">
                                    <?php if($imagen): ?>
                                        <img src="<?php echo e($imagen->temporaryUrl()); ?>" class="mx-auto h-32 object-cover rounded mb-2">
                                ...
                                <label for="video-input" class="cursor-pointer">
                                    <?php if($video): ?>
                                        <div class="flex items-center justify-center">
                                            ...
                                            <span class="text-xs text-green-600">Video seleccionado: <?php echo e($video->getClientOriginalName()); ?></span>
                                        </div>
                                    <?php else: ?>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition-colors cursor-pointer">
                                ...
                                <label for="imagen-edit-input" class="cursor-pointer">
                                    ...
                                    <?php elseif($imagenActual): ?>
                                        <img src="<?php echo e(asset('storage/' . $imagenActual)); ?>" class="mx-auto h-32 object-cover rounded mb-2">
                            ...
                            <?php if($videoActual): ?>
                                <div class="mb-2">
                                    <video controls class="w-full h-24 rounded">
                                        <source src="<?php echo e(asset('storage/' . $videoActual)); ?>" type="video/mp4">
                                    </video>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:bg-gray-50 transition-colors">
                                ...
                                <label for="video-edit-input" class="cursor-pointer">
                                    <?php if($video): ?>
                                        <div class="flex items-center justify-center">
                                            <span class="material-icons text-green-500 text-3xl mr-2">videocam</span>
                                            <span class="text-xs text-green-600">Nuevo video: <?php echo e($video->getClientOriginalName()); ?></span>
                                        </div>
                                    <?php else: ?>
                                        <span class="material-icons text-gray-400 text-3xl mb-1">video_library</span>
                                        <p class="text-xs text-gray-500"><?php echo e($videoActual ? 'Cambiar video' : 'Subir video'); ?></p>
                                        <p class="text-[10px] text-gray-400 mt-1">MP4, WEBM, OGG, MOV, AVI hasta 50MB</p>
                                    <?php endif; ?>
                                </label>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <?php if($pdfActual): ?>
                                <p class="text-xs text-gray-500 mb-2">PDF actual: <a href="<?php echo e(asset('storage/' . $pdfActual)); ?>" target="_blank" class="text-blue-600 hover:underline">Ver PDF</a></p>
                            <?php endif; ?>
                            <input type="file" wire:model="archivo_pdf" accept=".pdf" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            <?php $__errorArgs = ['archivo_pdf'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
    ...
    <script>
        (function() {
            ...
            function inicializarCarruselAlCargar() {
                const carruselActivo = <?php echo json_encode($carruselAutomatico, 15, 512) ?>;
                const intervaloInicial = <?php echo json_encode($intervaloCarrusel, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\citas\resources\views/livewire/campanas/consulta.blade.php ENDPATH**/ ?>