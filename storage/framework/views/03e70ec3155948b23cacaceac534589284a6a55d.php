        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-xl text-gray-600 mt-4">Bienvenido <?php echo e(Auth::user()->name); ?></p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow border border-gray-200 group">
                        <div class="flex items-start justify-between mb-4">
                            <a href="<?php echo e(route('cita.solicitar')); ?>" class="text-xl font-semibold hover:underline" style="color: #2c4370;">Solicitar nueva cita</a>
                        ...
                        <a href="<?php echo e(route('cita.solicitar')); ?>" class="inline-flex items-center mt-4 font-medium hover:underline" style="color: #2c4370;">
                            Solicitar cita
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg hover:shadow-md transition-shadow border border-gray-200 group">
                        <div class="flex items-start justify-between mb-4">
                            <a href="<?php echo e(route('cita.consulta')); ?>" class="text-xl font-semibold hover:underline" style="color: #2c4370;">Consultar mis citas</a>
                            <svg class="w-8 h-8 text-gray-300 group-hover:text-blue-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                        </div>
                        <p class="text-gray-600 mt-2">Consulta el estado de tus citas médicas agendadas.</p>
                        <a href="<?php echo e(route('cita.consulta')); ?>" class="inline-flex items-center mt-4 font-medium hover:underline" style="color: #2c4370;">
                            Consultar cita
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
            ...
            <?php if($mostrarSeccionCampanas && $campanas->count() > 0): ?>
                ...
                <div class="p-4 overflow-hidden">
                    <div id="carrusel-campanas" class="flex transition-transform duration-500 ease-in-out" style="gap: 1rem;">
                        ...
                        <div class="relative rounded-lg overflow-hidden group shadow hover:shadow-md transition-shadow cursor-pointer flex-shrink-0" style="width: calc(33.333% - 0.67rem);">
                            <?php if($campana->video): ?>
                                <video class="w-full h-28 object-cover" autoplay muted loop playsinline>
                                    <source src="<?php echo e(asset('storage/' . $campana->video)); ?>" type="video/mp4">
                                </video>
                            <?php elseif($campana->imagen): ?>
                                <img alt="<?php echo e($campana->titulo); ?>" class="w-full h-28 object-cover transform group-hover:scale-105 transition-transform duration-500" src="<?php echo e(asset('storage/' . $campana->imagen)); ?>"/>
                            <?php else: ?>
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t 
                                <?php if($campana->categoria === 'urgente'): ?> from-red-900/90 via-red-900/40 
                                <?php elseif($campana->categoria === 'noticia'): ?> from-purple-900/90 via-purple-900/40
                                <?php elseif($campana->categoria === 'servicio'): ?> from-green-900/90 via-green-900/40
                                <?php else: ?> from-blue-900/90 via-blue-900/40 <?php endif; ?> 
                                to-transparent p-3 flex flex-col justify-end">
                                <span class="text-[10px] font-bold uppercase tracking-wider
                                    <?php if($campana->categoria === 'urgente'): ?> text-red-300
                                    <?php elseif($campana->categoria === 'noticia'): ?> text-purple-300
                                    <?php elseif($campana->categoria === 'servicio'): ?> text-green-300
                                    <?php else: ?> text-blue-300 <?php endif; ?>">
                                ...
                                <h3 class="font-semibold leading-tight" 
                                    style="font-family: <?php echo e($fuenteTexto); ?>; color: <?php echo e($colorTexto); ?>; font-size: <?php echo e($tamanoTexto); ?>px;">
                                    <?php echo e($campana->titulo); ?>

                                </h3>
                                <?php if($campana->descripcion): ?>
                                <p class="mt-1 line-clamp-2" style="color: <?php echo e($colorTexto); ?>; opacity: 0.8; font-size: <?php echo e(max($tamanoTexto - 2, 10)); ?>px;"><?php echo e(Str::limit($campana->descripcion, 60)); ?></p>
                                <?php endif; ?>
                            </div>
                            <?php if($campana->archivo_pdf): ?>
                            <a href="<?php echo e(asset('storage/' . $campana->archivo_pdf)); ?>" target="_blank" class="absolute top-2 right-2 bg-red-500 text-white p-1 rounded-full hover:bg-red-600 transition-colors" title="Ver PDF">
            ...
            <script>
                (function() {
                    ...
                    const totalCampanas = <?php echo e($campanas->count()); ?>;
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\citas\resources\views/dashboard.blade.php ENDPATH**/ ?>