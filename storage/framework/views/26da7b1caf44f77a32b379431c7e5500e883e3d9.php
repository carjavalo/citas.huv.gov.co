                ...
                <div class="bg-gray-100 rounded-lg grid grid-cols-6 gap-6 mb-2 select-text">
                    ...
                    <div class="col-span-6 mx-2 mb-2">
                        ...
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                            <a target="_blank" href="<?php echo e(asset($archivos['historia'])); ?>">Historia</a>
                        </span>
                        <?php if($archivos['autorizacion']): ?>
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                <a target="_blank" href="<?php echo e(asset($archivos['autorizacion'])); ?>">Autorizacion</a>
                            </span>
                        <?php endif; ?>
                        <?php if($archivos['soporte_patologia']): ?>
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                <a target="_blank" href="<?php echo e(asset($archivos['soporte_patologia'])); ?>">Soporte patología</a>
                            </span>
                        <?php endif; ?>
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                <a target="_blank" href="<?php echo e(asset($archivos['orden'])); ?>">Orden Médica</a>
                            </span>
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                <a target="_blank" href="<?php echo e(asset($archivos['documento'])); ?>">Documento</a>
                            </span>
                    </div>
                    <?php if($observacion): ?>
