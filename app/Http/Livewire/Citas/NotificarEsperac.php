...
class NotificarEsperac extends Component
{
    public $sol_id;
    ...
    public function mount($solicitud_id)
    {
        try { 
            ...
            $this->mensaje = 'Informamos que en el momento no contamos con agenda para la especialidad que requiere, por tal motivo usted pasará a lista de espera. Por favor estar pendiente de una respuesta por este medio.'; //Solución temporal mientras se implementa la tabla RespuestaSolicitud
        } catch (\Throwable $th) {
    ...
    {
        return view('livewire.citas.notificar-esperac');
    }
