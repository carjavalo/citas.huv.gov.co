...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark navbar-custom">
    <div class="container-fluid">
      <!-- Logo -->
      <a class="navbar-brand d-flex align-items-center" href="{{ route('menuagenda') }}">
        <img src="{{url('dist/img/logo.jpg')}}" alt="Logo" class="rounded-circle mr-2" style="width: 40px; height: 40px;">
      ...
      <div class="collapse navbar-collapse" id="navbarMain">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="usuariosDropdown">
              <a class="dropdown-item" href="{{ route('usuarios_agenda') }}">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-custom" aria-labelledby="agendaDropdown">
              ...
              <a class="dropdown-item" href="{{ route('list_servicios') }}">
        ...
        <ul class="navbar-nav ml-auto align-items-center">
          <li class="nav-item mr-3 d-flex align-items-center">
            <img src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" class="rounded-circle mr-2" style="width: 35px; height: 35px; object-fit: cover; border: 2px solid white;">
            <span class="text-white">{{ Auth::user()->name }} {{ Auth::user()->apellido1 }}</span>
          </li>
          <li class="nav-item">
            <a href="{{route('dashboard')}}" class="nav-link btn-salir px-3">
