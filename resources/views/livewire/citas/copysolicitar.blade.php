                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="espec" class="block text-sm font-semibold">Especialidades<span class="text-red-500">*</span></label>
                                                 <div wire:ignore>
                                                    <select wire:model="espec" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none sm:text-sm" id="select2">
