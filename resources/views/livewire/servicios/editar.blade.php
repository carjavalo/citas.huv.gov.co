                ...
                <div class="mb-4 text-center">
                    ...
                    <div class="rounded-lg grid grid-cols-6 gap-6 mb-4">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="servicio.nombre" class="block text-sm font-medium text-gray-700">Nombre</label>
                                <input  type="text" id="servicio.nombre" wire:model="nombre" autocomplete="off" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                @error('nombre') <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-500 text-white">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="grid grid-cols-6 gap-6 space-x-20">
                            ...
                            <div class="block col-span-6 sm:col-span-3">
                                <button wire:click.prevent="$emitTo('servicios.consulta','cerrarModal')" type="button" class="transition ease-in-out delay-150 bg-red-600 hover:-translate-y-1 hover:scale-110 hover:bg-red-700 duration-300 inline-flex py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white">
                                    Cancelar
                                </button>
                            </div>
                        </div>
