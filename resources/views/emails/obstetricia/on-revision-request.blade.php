...
La solicitud para la paciente {{$paciente->primer_nombre}} {{$paciente->segundo_nombre}} {{$paciente->primer_apellido}} {{$paciente->segundo_apellido}} se encuentra en revisión.<br>
