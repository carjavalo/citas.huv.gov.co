...
Estimado(a) {{ $usuario }}, le informamos que su solicitud para la especialidad de **{{ $especialidad }}** ha salido de lista de espera y está siendo procesada nuevamente.

Pronto recibirá información sobre el agendamiento de su cita.
