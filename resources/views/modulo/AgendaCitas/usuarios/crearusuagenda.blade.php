        ...
        <div class="col-md-10">
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h3 class="card-title" style="font-weight: bold;">Ingrese los Datos</h3>
              ...
              <div class="card-body" style="display: block;">
                <div class="container">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{url('modulo/AgendaCitas/usuarios/crearusuagenda')}}" method="POST">
                                @csrf
                              <!--method('POST')-->
                                <div class="row">
                                    <!-- Primera columna -->
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name" value="{{old('name')}}" class="form-control" required autofocus autocomplete="off" > 
                                        @error('name')     
                                         <small style="color:red">{{$message}}</small>                                                                              
                                        @enderror
                                        <label for="apellido1">apellido</label><b>*</b>
                                        <input type="text" name="apellido1"  class="form-control" required autocomplete="off">
                                        @error('apellido1')     
                                         <small style="color:red">{{$message}}</small>                                                                              
                                        @enderror
                                        ...
                                        <input type="text" name="ndocumento" class="form-control" required autocomplete="off">
                                        @error('ndocumento')     
                                          <small style="color:red">{{$message}}</small>                                                                              
                                        @enderror
                                  </div>
                                    ...
                                    <div class="col-md-6">
                                      <label for="eps">Eps</label><b>*</b>
                                        ...
                                        <input type="text" name="telefono1"  class="form-control" required autofocus autocomplete="off">
                                        @error('telefono1')     
                                           <small style="color:red">{{$message}}</small>                                                                              
                                        @enderror
                                ...
                                <div class="mt-4">
                                    <button type="submit" class="nav-icon fas bi bi-floppy-fill btn btn-primary">Agregar</button>
