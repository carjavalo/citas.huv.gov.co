<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="apellido1" type="text" class="mt-1 block w-full" wire:model.defer="state.apellido1" />
            <x-jet-input-error for="apellido1" class="mt-2" />
        </div>

        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="apellido2" value="{{ __('Segundo apellido') }}" />
            <x-jet-input id="apellido2" type="text" class="mt-1 block w-full" wire:model.defer="state.apellido2" />
